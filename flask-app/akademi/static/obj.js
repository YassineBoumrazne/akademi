          ...
          if (teacher == true) {
            ...
            for (var key in s) {
              if (key != "class&") {
                ...
                var bt1 = document.getElementById("drawAlert");
                
                bt1.style.backgroundColor = color1;
                

                var bt2 = document.getElementById("yawnAlert");
                
                bt2.style.backgroundColor = color2;
                

                var bt3 = document.getElementById("posAlert");
            ...
            var bt1 = document.createElement("drawAlert");
            bt1.style.backgroundColor = color1;

            var bt2 = document.createElement("yawnAlert");
            bt2.style.backgroundColor = color2;

            var bt3 = document.createElement("butposAlertton");
            bt3.style.backgroundColor = color3;
