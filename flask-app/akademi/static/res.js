...
xhr.onload = function () {
    if (this.status == 200) {
        ...
        // z.innerHTML = "<li>Lecture Time "+(time/60.0).toFixed(2)+" minutes</li>"

        var totalSeconds = time; // Replace with your actual total time in seconds

        var hours = Math.floor(totalSeconds / 3600);
        var minutes = Math.floor((totalSeconds % 3600) / 60);
        var seconds = totalSeconds % 60;

        var displayText = "<li>Lecture Time " + hours.toFixed(2) + " hours, " + minutes.toFixed(2) + " minutes, " + seconds.toFixed(2) + " seconds</li>";
        z.innerHTML = displayText;


        // var time = 120; // Replace with your actual time value
        // var displayText = "<li>Lecture Time " + (time/60.0).toFixed(2) + " minutes</li>";
        // z.innerHTML = displayText;
